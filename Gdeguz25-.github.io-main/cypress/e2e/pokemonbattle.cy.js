describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('Gdeguzel@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('SadXcz159321');               // вводим пароль
         ...
         cy.get('.card_name').type('Gdeguz');                           // вводим имя владельца действия карты
